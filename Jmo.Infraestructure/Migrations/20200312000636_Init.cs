        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagenUrl = table.Column<string>(maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Cuestionante = table.Column<string>(maxLength: 150, nullable: true),
                    ImagenUrl = table.Column<string>(maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Opcion = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Preguntas_Cuestionante",
                table: "Preguntas",
                column: "Cuestionante",
                unique: true,
                filter: "[Cuestionante] IS NOT NULL");
